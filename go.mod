...
require (
	...
	github.com/containers/common v0.50.2-0.20230118142943-edca0cc051c8 // indirect
	github.com/containers/image/v5 v5.23.1-0.20230116122250-3d22f4e96c53 // indirect
